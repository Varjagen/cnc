...
const CONDITION_GROUPS = {
  negative: ['Blinded', 'Charmed', 'Deafened', 'Frightened', 'Grappled', 'Incapacitated', 'Paralyzed', 'Petrified', 'Poisoned', 'Prone', 'Restrained', 'Slowed', 'Stunned', 'Unconscious', 'Exhausted', 'On Fire', 'Bleeding', 'Cursed', 'Marked'],
...
const BNB_TOKEN_PRESETS = [{
  ...
  "entity": {
    ...
    "playerDescription": "The most common companion bird in grovetowns. Badgermen smiths keep them for their sharp warning calls.",
  ...
  "entity": {
    ...
    "playerDescription": "Small and nimble enough to navigate the dense hanging bridges and pulley systems of grovetowns.",
  ...
  "entity": {
    ...
    "playerDescription": "The standard beginner's riding bird. Found in most grovetowns and walled grassland settlements alike.",
  ...
  "entity": {
    ...
    "playerDescription": "A reliable cross-country messenger bird. The backbone of interclan communication.",
  ...
  "entity": {
    ...
    "playerDescription": "The workhorse riding bird of the continent. Fast, durable, and relatively easy to train.",
  ...
  "entity": {
    ...
    "playerDescription": "Popular as a defensive mount in Harefolk settlements. Slow but immovable on rough terrain.",
  ...
  "entity": {
    ...
    "playerDescription": "Prized as a tunnel-fighter and hunting companion. A Ferret-mounted warrior is a terrifying presence in narrow forest-floor lanes.",
  ...
  "entity": {
    ...
    "playerDescription": "Domesticated in the riverlands. An excellent mount for crossing marshland and rain-soaked forest floors.",
    "notes": "Rideable | Medium | CR 1"
  }
}, {
  "id": "bnb:bank_vole",
  ...
  "entity": {
    ...
    "playerDescription": "Farmed extensively in grovetowns and Harefolk settlements. Their fine, soft hides are prized for delicate leatherwork.",
    "notes": "Small | CR 1/8"
  }
}, {
  "id": "bnb:house_spider",
  ...
  "entity": {
    ...
    "playerDescription": "The silent workhorses of Mousefolk homes and Badgermen workshops.",
    "notes": "Small | CR 1/4"
  }
}, {
  "id": "bnb:bullfinch",
...
function presetAssetSlugs(preset) {
  ...
  for (const cand of [suffix, slugify(suffix), slugify(preset.name), slugify(preset.entity?.name)]) {
    ...
    case 'CHAT_ADD':
      {
        ...
        if (!m || !m.text) return state;
        const next = [...(state.chat || []), m];
  ...
  async joinSession(roomCode, playerId, playerName) {
    ...
    try {
      ...
      this.peer.on('open', id => {
        ...
        conn.on('data', data => {
          if (data.type === 'state_update') this.onStateUpdate?.(data.payload);else if (data.type === 'map_image') this.onMapImage?.(data.mapId, data.dataUrl, data.layerId);else if (data.type === 'token_pos') this.onTokenPos?.(data.tokenId, data.x, data.y, data.mapId);else if (data.type === 'sound_data') this.onSoundData?.(data.soundId, data.name, data.dataUrl);else if (data.type === 'kicked') {
...
function TokenView({
  ...
  }) : /*#__PURE__*/React.createElement("span", null, initial)), passivelyHidden && /*#__PURE__*/React.createElement("div", {
...
function MapCanvas({
  ...
  })(), (blockZones.length > 0 || drawingBlock || drawingPoly || drawingCircle) && /*#__PURE__*/React.createElement("svg", {
...
function TokenDetailPanel({
  ...
  })), isDM && entity.type === 'Monster' && entity.abilities && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 10
    }
...
function SettingsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "theme-sub"
  }, "Grass · bloom")))), mode === 'dm' && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
...
function CharacterSheet({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "csheet-field grow"
  }, /*#__PURE__*/React.createElement("label", null, "Race / Kin"), /*#__PURE__*/React.createElement(LiveInput, {
    value: entity.race || '',
    onCommit: v => onField({
      race: v
    }),
  ...
  }, [['AC', 'ac', 0, 40, 1], ['Speed', 'speed', 0, 120, 5], ['Init', 'initBonus', -10, 20, 1], ['Passive', 'passivePerception', 0, 40, 1], ['Prof', 'proficiencyBonus', 0, 20, 1]].map(([lbl, f, mn, mx, st]) => /*#__PURE__*/React.createElement("div", {
    key: f,
...
function HpRoller({
  ...
  const go = () => {
    ...
    rolls.forEach((r, idx) => {
      const lvl = idx + 1;
      // cycle the face for this step
      tmr.current.push(setTimeout(() => {
        clearInterval(cyc.current);
        if (lvl > 1) cyc.current = setInterval(() => setCur(1 + Math.floor(Math.random() * die)), 70);else setCur(die);
      }, delay));
      tmr.current.push(setTimeout(() => {
        clearInterval(cyc.current);
        setCur(r);
      ...
      tmr.current.push(setTimeout(() => {
        ...
        setCur(null);
      }, delay + (lvl > 1 ? 1300 : 700)));
      delay += lvl > 1 ? 1500 : 900;
    });
    tmr.current.push(setTimeout(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: go,
    disabled: running
  }, running ? 'Rolling…' : '🎲 Generate HP'), cur != null && /*#__PURE__*/React.createElement("div", {
    className: "hp-cur"
...
function NewCharacterBuilder({
  ...
  }, [phase, name, race, level, pool, assign, cls, classLocked, hp]);
  ...
  const conMod = stats.con != null ? abilityMod(stats.con) : 0;
  ...
  const Stepper = /*#__PURE__*/React.createElement("div", {
    className: "cc-steps"
  }, ['Race', 'Stats', 'Class', 'Health'].map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: s,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "builder-field grow"
  }, /*#__PURE__*/React.createElement("label", null, "Race"), /*#__PURE__*/React.createElement("select", {
    className: "class-select",
    value: race,
    onChange: e => setRace(e.target.value)
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "— Choose a race —"), DND_RACES.map(r => /*#__PURE__*/React.createElement("option", {
    key: r.name,
    value: r.name
  }, r.name)))), raceData && /*#__PURE__*/React.createElement("div", {
    className: "cc-info"
  ...
  }, raceData.bonus)), /*#__PURE__*/React.createElement("div", {
    className: "builder-field grow"
    ...
    disabled: !race,
    onClick: () => setPhase(2)
  }, "Next: Stats →"))), phase === 2 && /*#__PURE__*/React.createElement("div", {
    className: "cc-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cc-sub"
    ...
    onClick: () => setPhase(3)
  }, "Next: Class →"))), phase === 3 && /*#__PURE__*/React.createElement("div", {
    className: "cc-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "builder-field grow"
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", null, "Primary"), " ", CLASS_INFO[cls].primary, " · ", /*#__PURE__*/React.createElement("b", null, "Saves"), " ", CLASS_INFO[cls].saves, " · ", /*#__PURE__*/React.createElement("b", null, "Hit die"), " d", CLASS_HIT_DIE[cls]), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", null, "Skills"), " ", CLASS_INFO[cls].skills), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", null, "Weapons"), " ", CLASS_INFO[cls].weapons, " · ", /*#__PURE__*/React.createElement("b", null, "Armor"), " ", CLASS_INFO[cls].armor), CLASS_INFO[cls].tools !== 'None' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", null, "Tools"), " ", CLASS_INFO[cls].tools), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("b", null, "Equipment"), " ", CLASS_INFO[cls].equipment)), !classLocked ? /*#__PURE__*/React.createElement("div", {
    className: "builder-actions"
  }, /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    onClick: () => setPhase(2)
    ...
    disabled: !cls,
    onClick: () => {
      if (confirm(`Lock in ${cls}? You won't be able to change your class after this.`)) setClassLocked(true);
    }
  }, "🔒 Lock class")) : /*#__PURE__*/React.createElement("div", {
    className: "builder-actions"
  }, /*#__PURE__*/React.createElement("span", {
    className: "cc-locked"
  }, "🔒 ", cls, " locked in."), /*#__PURE__*/React.createElement("button", {
    className: "btn primary",
    onClick: () => setPhase(4)
  }, "Next: Health →"))), phase === 4 && /*#__PURE__*/React.createElement("div", {
    className: "cc-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cc-sub"
  ...
  }, /*#__PURE__*/React.createElement("b", null, name || `${race} ${cls}`), " — ", race, " ", cls, ", level ", level, /*#__PURE__*/React.createElement("div", {
    className: "cc-summary-stats"
  }, ABILITY_KEYS.map(k => /*#__PURE__*/React.createElement("span", {
    key: k
  }, k.toUpperCase(), " ", stats[k], " (", abilityMod(stats[k]) >= 0 ? '+' : '', abilityMod(stats[k]), ")")))), /*#__PURE__*/React.createElement("div", {
    className: "builder-actions"
  }, /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    onClick: () => setPhase(3)
...
function ChatPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `chat-panel ${collapsed ? 'collapsed' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "chat-as static",
    title: "You speak as your character"
  }, myName), /*#__PURE__*/React.createElement("input", {
    className: "chat-input",
    value: input,
    maxLength: TUNING.chatMaxChars,
    placeholder: isDM ? 'Message…   try /whisper Name …' : 'Message…',
    onChange: e => {
...
function DMInterface({
  ...
  const chatTokenNames = useMemo(() => {
    ...
    for (const t of Object.values(state.tokens || {})) {
      if (t.mapId !== currentMapId) continue;
      const e = state.entities[t.entityId];
      if (e && e.name && e.type !== 'Label' && !seen.has(e.name)) {
        seen.add(e.name);
        names.push(e.name);
      }
    }
...
'money', 'xp', 'proficiencyBonus', 'hitDice', 'race', 'background', 'alignment', 'attacks', 'spells', 'features', 'proficiencies', 'inventory', 'traits', 'ideals', 'bonds', 'flaws', 'backstory']);
    ...
    const sync = new SyncManager({
      ...
      onMapImage: (mapId, dataUrl, layerId) => {
        ...
        if (layerId) {
          ...
          console.log(`[plagues-call] received layer image ${layerId.slice(-6)} in ${(performance.now() - t0).toFixed(0)}ms`);
          return;
        }
      ...
      jobs.forEach(job => {
        ...
        const t = setTimeout(() => {
          ...
          try {
            ...
            sentSet.add(job.key);
            console.log(`[plagues-call] image ${job.key.slice(-6)} → ${pid.slice(-6)}`);
          } catch (err) {
      ...
      case 'submit_request':
        {
          ...
          if (!['new_character', 'stat_change', 'level_change'].includes(kind)) return;
          ...
          toast(`${req.playerName} requests ${kind === 'new_character' ? 'a new character' : kind === 'level_change' ? 'a level change' : 'a stat change'}`, 'info');
          pushSoon();
          return;
        }
      ...
      case 'patch_own_entity':
        {
          ...
          if (op === 'hp_adjust') {
            ...
            for (const tf of ['hitDice', 'race', 'background', 'alignment', 'attacks', 'spells', 'features', 'proficiencies', 'inventory', 'traits', 'ideals', 'bonds', 'flaws', 'backstory']) {
